package it.polito.tdp.demografia.model;
...
public class Movimento {
	...
	public Movimento(Date registrazione, int circoscrizioneProvenienza,
			int circoscrizioneDestinazione, int numeroEventi) {
		super();
